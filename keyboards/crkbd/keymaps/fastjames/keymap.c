...
#define BSP_LWR LT(LOWER, KC_BSPC)
#define TAB_RAI LT(RAISE, KC_TAB)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------+-------+-------+-------+-------+-------|          |-------+-------+-------+-------+-------+-------|
                                KC_LGUI, KC_SPC,BSP_LWR,   TAB_RAI,KC_ENTER,KC_RALT                          \
                             //`-----------------------'  `----------------------'
  ),
  ...
  //|-------+-------+-------+-------+-------+-------|          |-------+-------+-------+-------+-------+-------|
     _______,KC_PSCR,_______,KC_DOWN, KC_UP, _______,           _______,_______,KC_HOME,KC_PGUP,KC_PGDN, KC_END,\
  //|-------+-------+-------+-------+-------+-------|          |-------+-------+-------+-------+-------+-------|
                                _______,_______,_______,          , KC_DEL,_______ \
                             //`-----------------------'  `----------------------'
  )
